  ...
  "questions": [
    {
      ...
      "explanation": "A basic linked list node must contain two main fields, being the data and the next node. However the next node must be a pointer to another struct node rather than an integer."
    },
    {
      "questionNum": 2,
    ...
    },
    {
      ...
      "explanation": "Linked lists provide the ability to dynamically alter the amount of space needed to store varied amountes of data. An array, as an alternative, has a fixed size and once it is full more data cannot be added easily."
    },
  ]
}