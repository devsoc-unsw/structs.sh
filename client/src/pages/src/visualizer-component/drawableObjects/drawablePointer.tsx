...
import { AttachableEntity, getAttachableEntityShape } from '../types/coreEntity/attachableEntity';
...
const PointerDrawable: DrawablePointerComponent = ({ entity, attachedEntity, pos }, ref) => {
