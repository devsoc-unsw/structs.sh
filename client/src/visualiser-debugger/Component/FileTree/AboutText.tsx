const AboutText = () => (
  <>
    ...
    <p>
      Get started by writing your C code onto the code editor and clicking the Run button. You then
      have the option to configure the data types and variables that help us visualise your data
      structure(s). Then, you can debug and visualise your program in real time by pressing the Next
      button!
    </p>
    <p>
