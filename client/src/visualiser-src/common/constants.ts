...
// Size parameters.
export const EDGE_WIDTH = '2px';
export const ARROWHEAD_FATNESS = '32px';
export const ARROWHEAD_POSITION_OFFSET = 1;
export const WEIGHT_LABEL_SIZE = '22px';
export const VERTEX_FILL = '#ebe8f4';
export const VERTEX_STROKE = '#000000';
export const VERTEX_FONT_SIZE = '28px';
export const NODE_RADIUS = 24;
export const EDGE_PATH_D = 'M 0,-4.5 L 9,0 L 0,4.5';
export const EDGE_FILL = '#000000';
export const EDGE_OPACITY = 1;
export const ARROWHEAD_FILL = '#000000';
