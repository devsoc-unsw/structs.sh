...
// This function has 2 bugs, it does not update the size of the lsit
// It also does not check cases for 0 or 1 elements
void remove_val_d(listd_t *list, double val) {
